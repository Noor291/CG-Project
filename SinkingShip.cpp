...
{
    glClearColor(0.75, 0.86, 0.92, 1.0); // Buffer clearing
...
{
    glScaled(24, 24, 0);
    glColor3f(0.220, 0.220, 0.220); // base
    glBegin(GL_POLYGON);
    glVertex2f(0.5, 5.0);
    glVertex2f(3, 1);
    glVertex2f(22, 1);
    ...
    glColor3f(0.482, 0.561, 0.631); // ring
    glBegin(GL_POLYGON);
    glVertex2f(1.35, 3.5);
    glVertex2f(1.6, 3.2);
    glVertex2f(23.2, 3.2);
    ...
    glVertex2f(17.5, 8.2);
    glEnd();
    glColor3f(0.482, 0.561, 0.631); // window
    glBegin(GL_POLYGON);
    glVertex2f(3.0, 6.0);
    glVertex2f(3.0, 7.2);
    glVertex2f(4.0, 7.2);
    ...
    glVertex2f(14.3, 9.8);
    glEnd();
    glColor3f(0.220, 0.220, 0.220); // top-cover
    glBegin(GL_POLYGON);
    glVertex2f(1.5, 12.0);
    glVertex2f(1.5, 12.5);
    ...
    glEnd();
    glColor3f(0.220, 0.220, 0.220); // chim
    glBegin(GL_POLYGON);
    glVertex2f(2.5, 12.5);
    glVertex2f(2.5, 16.0);
    glVertex2f(5.0, 16.0);
    ...
    glVertex2f(8.5, 14.5);
    glEnd();
    glColor3f(0.941, 0.941, 0.941); // ring
    glBegin(GL_POLYGON);
    glVertex2f(6.0, 12.5);
    glVertex2f(6.0, 13.5);
    glVertex2f(8.5, 13.5);
